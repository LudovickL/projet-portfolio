    ...
    return(
        <div className="Infos">
            ...
            <p className="texte">
                ...
                J'ai toujours été passioné par le domaine du jeu vidéo et j'ai une approche très expérimental dans l'industrie. 
                Je suis prêt à créer des expérience dynamiques qui vont enrichir la pensé et faire réfléchir à un message ou 
                une idée dans les jeu vidéos.
            </p>
            <p className="texte">
